  ...
  return (
    <Appscreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        ...
        <Appscreen.Subtitle>
          Get tips <span className="text-gray-200">5s sooner</span> for every
          invite.
        </Appscreen.Subtitle>
      ...
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="px-4 py-6">
          <div className="space-y-6">
            {[
              { label: "Full Name", value: "Rendy" },
              { label: "Email Address", value: "kepolaumautauaja@gmail.com" },
            ].map((field) => (
              <div key={field.label}>
          ...
          <div className="mt-6 rounded-lg bg-blue-600 px-3 py-2 text-center text-sm font-semibold text-white cursor-pointer">
            Invite person
          </div>
        </div>
      </MotionAppScreenBody>
...
function stockScreen({ custom, animated = false }) {
  return (
    <Appscreen className="w-full ">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
...
function InvestScreen({ custom, animated = false }) {
  return (
    <Appscreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <Appscreen.Title>Buy $USD</Appscreen.Title>
        <Appscreen.Subtitle>
          <span className="text-gray-200">$34.28</span> per share
        </Appscreen.Subtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="px-4 py-6">
