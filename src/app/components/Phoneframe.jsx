...
const Phoneframe = ({ className, children, priority = false, ...props }) => {
  return (
    <div className={clsx("relative aspect-[366/729]", className)} {...props}>
      ...
      <div className="absolute left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-700 pt-[calc(23/318*100%)]">
        {children}
      </div>
      <Placeholderframe className="pointer-events-none absolute inset-0 h-full w-full fill-gray-400" />
      <Image
        src={frame}
        alt="frame"
